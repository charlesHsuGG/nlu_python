...
appControllers.controller('AiEntityCtrl',['$scope', '$state', 'MercueRequests','$sce'
   ...
   $scope.submitText = function(){
       ...
       sendData.model_dir = "/home/mercue/rasa_core/rasa_nlu_chi/./models/default/current"
   ...
   $scope.sendText = function(){
		...
		MercueRequests.cueRequest(function(data, status, headers, config){
           ...
           if (data.code == 1) {
				var sendData1 = {};
				sendData1.model_dir = "/home/mercue/rasa_core/rasa_nlu_chi/./models/default/current"
				...
				MercueRequests.cueRequest(function(data, status, headers, config){
					...
					console.log(data);        
				}, "../ai/entity_mitie_train", sendData1);	
		   }
		},function(data, status, headers, config){
			console.log(data);        
		}, "../ai/entity_save", sendData); 
   }
